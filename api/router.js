                    ...
                    chrome.getOrderShippedPageHtml().then(ShipedOrderhtml=> {
                        ...
                        if (config["FBA"] && readMission.length === 0) {
                            chrome.getInventoryPageHtml().then(InventoryHtml => {
                                ...
                                let canceledUrl = "https://sellercentral." + amazonHost + "/orders-api/search?limit=1000&offset=0&sort=order_date_desc&date-range=last-30&fulfillmentType=fba&orderStatus=canceled&forceOrdersTableRefreshTrigger=false";
